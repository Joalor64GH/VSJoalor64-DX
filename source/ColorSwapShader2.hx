...
/*
 * Literally just a copy of ColorSwap.hx
 * But this is meant to be used in TitleState.hx
 */

class ColorSwapShader2 extends FlxGraphicsShader
{
	@:glFragmentSource('
...
class ColorSwap2
{
	public var shader(default, null):ColorSwapShader2 = new ColorSwapShader2();
